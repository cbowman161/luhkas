...
from scout.config import VaultMemoryConfig, CollisionConfig, FaceDetectionConfig, FaceRecognitionConfig, GuardConfig, MotionConfig, PersonMemoryConfig, SearchConfig, TrackingConfig, VisionConfig
